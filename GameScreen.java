...
public class GameScreen implements Screen {
	...
	public GameScreen(final GameLluviaMenu game) {
        ...
        this.font = game.getFont();
         ...
         Texture gotaDorada = new Texture(Gdx.files.internal("gotaDorada.png"));
         Texture escudoTexture = new Texture(Gdx.files.internal("escudo.png"));
         Texture snowball = new Texture(Gdx.files.internal("snowball.png"));
         Texture snowflake = new Texture(Gdx.files.internal("snowflake.png"));
         Texture gotaVerde = new Texture(Gdx.files.internal("poisondrop.png"));
         Texture iconoVerde = new Texture(Gdx.files.internal("poisonicon.png"));
         
         Sound dropSound = Gdx.audio.newSound(Gdx.files.internal("drop.wav"));
        
	     Music rainMusic = Gdx.audio.newMusic(Gdx.files.internal("rain.mp3"));
         lluvia = new Lluvia(gota, gotaMala, gotaDorada, escudoTexture, snowball, snowflake, gotaVerde, iconoVerde, dropSound, rainMusic);
	...
	public void render(float delta) {
		...
		int nivelActual = lluvia.getTotalGotasGeneradas() / 100 + 1;
