...
public class GameOverScreen implements Screen {
	...
	public void render(float delta) {
		...
		batch.draw(gameOverTexture, 290, 215, gameOverTexture.getWidth() * scaleX, gameOverTexture.getHeight() * scaleY);
		font.draw(batch, "Toca en cualquier lado para reiniciar.", 162, 172);
		batch.end();
